...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        Paint tGreen = new Paint(ManufacturerType.TAMIYA,"X-5","81006","Green",PaintType.ENAMEL,ColourType.GREEN,"005B40","14ML");
        paintRepository.save(tGreen);
        Paint tSilver = new Paint(ManufacturerType.TAMIYA,"X-11","81012","Chrome Silver",PaintType.ENAMEL,ColourType.GREY,"9B9D9F","14ML");
        paintRepository.save(tSilver);
        Paint tBlue = new Paint(ManufacturerType.TAMIYA,"X-4","81005","Blue",PaintType.SPRAY_ACRYLIC,ColourType.BLUE,"0F7BB3","200ML");
        paintRepository.save(tBlue);
        Paint tRed = new Paint(ManufacturerType.TAMIYA,"X-7","81008","Red",PaintType.ENAMEL,ColourType.RED,"CD4F3A","14ML");
        paintRepository.save(tRed);
        Paint tSky = new Paint(ManufacturerType.TAMIYA,"XF-21","81322","Sky",PaintType.ENAMEL,ColourType.BLUE,"BCD0A7","14ML");
        paintRepository.save(tSky);
        Paint tKhaki = new Paint(ManufacturerType.TAMIYA,"XF-49","81350","Khaki",PaintType.ACRYLIC,ColourType.YELLOW,"A79656","50ML");
        paintRepository.save(tKhaki);
        Paint tEarth = new Paint(ManufacturerType.TAMIYA,"XF-52","81353","Flat Earth",PaintType.ENAMEL,ColourType.YELLOW,"AB8957","14ML");
        paintRepository.save(tEarth);
        Paint tBlack = new Paint(ManufacturerType.TAMIYA,"XF-1","81302","Flat Black",PaintType.ENAMEL,ColourType.BLACK,"333231","14ML");
        paintRepository.save(tBlack);
        Paint tWhite = new Paint(ManufacturerType.TAMIYA,"XF-2","81303","Flat White",PaintType.ENAMEL,ColourType.WHITE,"FFFFFF","14ML");
        paintRepository.save(tWhite);
        Paint tGunMetal = new Paint(ManufacturerType.TAMIYA,"X-10","81011","Gun Metal",PaintType.ENAMEL,ColourType.GREY,"A9AAAD","14ML");
        paintRepository.save(tGunMetal);
        Paint tFlesh = new Paint(ManufacturerType.TAMIYA,"XF-15","81316","Flat Flesh",PaintType.ACRYLIC,ColourType.YELLOW,"FEDCB8","50ML");
        paintRepository.save(tFlesh);
        Paint tGermanGrey = new Paint(ManufacturerType.TAMIYA,"XF-63","81364","German Grey",PaintType.ENAMEL,ColourType.GREY,"56594F","14ML");
        paintRepository.save(tGermanGrey);
        Paint tMediumBlue = new Paint(ManufacturerType.TAMIYA,"XF-18","81319","Medium Blue",PaintType.SPRAY_ACRYLIC,ColourType.BLUE,"65829A","200ML");
        paintRepository.save(tMediumBlue);
        Paint fBrown = new Paint(ManufacturerType.TAMIYA,"XF-10","81311","Flat Brown",PaintType.ENAMEL,ColourType.GREEN,"5D483E","14ML");
        paintRepository.save(fBrown);
        Paint tRedBrown = new Paint(ManufacturerType.TAMIYA,"XF-64","81365","Red Brown",PaintType.ACRYLIC,ColourType.GREEN,"393227","50ML");
        paintRepository.save(tRedBrown);
        Paint tBuff = new Paint(ManufacturerType.TAMIYA,"XF-57","81358","Buff",PaintType.ENAMEL,ColourType.GREEN,"A79656","14ML");
        paintRepository.save(tBuff);
        Paint tGoldLeaf = new Paint(ManufacturerType.TAMIYA,"X-12","81013","Gold Leaf",PaintType.ACRYLIC,ColourType.YELLOW,"C5A971","50ML");
        paintRepository.save(tGoldLeaf);
        Paint tPurple = new Paint(ManufacturerType.TAMIYA,"X-16","81017","Purple",PaintType.ENAMEL,ColourType.VIOLET,"744E7A","14ML");
        paintRepository.save(tPurple);
        Paint tPink = new Paint(ManufacturerType.TAMIYA,"X-17","81018","Pink",PaintType.ENAMEL,ColourType.RED,"E7C1BB","14ML");
